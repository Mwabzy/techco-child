	...
	function tc_brand_icon( $key, $size = 40 ) {
		...
		$marks = array(
			...
			'javascript' =>
				...
				. '<path fill="#111" d="M7.4 13.1l1.78-.92c.21.45.46.76.94.76.46 0 .73-.18.73-.86V8.2h2.06v3.95c0 1.51-.88 2.2-2.17 2.2-1.16 0-1.84-.6-2.18-1.34zm5.9-.22l1.78-.84c.23.49.54.83 1.21.83.51 0 .84-.25.84-.6 0-.42-.33-.57-.9-.82l-.31-.13c-.9-.38-1.5-.86-1.5-1.87 0-.93.71-1.64 1.82-1.64.79 0 1.36.27 1.77 1l-1.71.71c-.21-.38-.44-.53-.78-.53-.35 0-.57.22-.57.53 0 .37.23.52.76.75l.31.13c1.06.45 1.66.91 1.66 1.95 0 1.12-.88 1.73-2.06 1.73-1.16 0-1.91-.55-2.28-1.27z"/>',
			...
			'nodejs' =>
				'<path fill="#5FA04E" d="M12 1.5l9 5.25v10.5L12 22.5l-9-5.25V6.75z"/>'
			...
			'mongodb' =>
				'<path fill="#47A248" d="M12 1.5c.9 2.6 2.4 4 3.6 5.5 1.6 2 2.4 4.1 2.4 6.4 0 4-2.6 6.8-4.9 8l-.5 2.6h-1.2l-.5-2.6C8.1 19.7 6 17 6 13.4c0-2.3.8-4.4 2.4-6.4C9.6 5.5 11.1 4.1 12 1.5z"/>'
				. '<path fill="#3F8C3F" d="M12 4.2c.7 1.7 1.6 3 1.6 5.6V21l-.9 1.4-.5-2.6c-.1-5-.2-10.6-.2-15.6z"/>',

			// SQL — database cylinder (conceptual, brand blue).
			'sql' =>
				'<g fill="none" stroke="#2f6bff" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">'
			...
			'rest-api' =>
				...
				. '</g><circle cx="12" cy="11.5" r="1.4" fill="#2f6bff"/>',

			// Auth & Security — shield + padlock (conceptual, brand orange).
			'auth-security' =>
				'<g fill="none" stroke="#ff7a18" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">'
