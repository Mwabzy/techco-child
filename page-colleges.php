...
$tc_org = array(
    ...
    'web' => 'www.visionerpsolutions.com/training',
    'phone' => '+91 8143533434',
    'wa' => '+91 8143533535',
            ...
            <div class="tc-coursebanner__inner">
                <div class="tc-coursebanner__content" data-motion-in>
                    ...
                    <p class="tc-coursebanner__desc">Industry-grade fullstack training for your campus — delivered
                        on-site or online at transparent bulk rates, with placement reporting and zero revenue-share.
                    </p>
                    ...
                    <div class="tc-coursebanner__actions">
                        ...
                        <a class="tc-btn tc-btn--ghost" href="tel:<?php echo esc_attr($tc_tel); ?>">Call the
                            placements team</a>
                    </div>
                </div>
            </div>
                ...
                <section class="tc-section tc-college-value tc-reveal tc-section--tint">
                    ...
                    <div class="tc-bento tc-bento--2col">
                        ...
                        <div class="tc-feature tc-reveal" style="--delay: 80ms">
                            <span
                                class="tc-feature__ic tc-feature__ic--violet"><?php echo tc_icon('sliders', 24); ?></span>
                        ...
                        <div class="tc-feature tc-reveal" style="--delay: 160ms">
                            <span
                                class="tc-feature__ic tc-feature__ic--amber"><?php echo tc_icon('chart', 24); ?></span>
                            ...
                            <tbody>
                                <?php foreach ($tc_bulk as $row): ?>
                                    <tr class="<?php echo $row['rec'] ? 'tc-ptable__row--rec' : ''; ?>">
                                        ...
                                        <td><strong><?php echo esc_html($row['b20']); ?></strong> <span
                                                class="tc-ptable__gst">+ GST</span></td>
                                        <td><strong><?php echo esc_html($row['b40']); ?></strong> <span
                                                class="tc-ptable__gst">+ GST</span></td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                ...
                <div class="tc-contact__col">
                    <ul class="tc-contact__list">
                        <li><span>Phone</span><a
                                href="tel:<?php echo esc_attr($tc_tel); ?>"><?php echo esc_html($tc_org['phone']); ?></a>
                        </li>
                        <li><span>WhatsApp</span><a
                                href="https://wa.me/<?php echo esc_attr(ltrim($tc_wa_tel, '+')); ?>" target="_blank"
                                rel="noopener"><?php echo esc_html($tc_org['wa']); ?></a></li>
                        <li><span>Email</span><a
                                href="mailto:<?php echo esc_attr($tc_org['email']); ?>"><?php echo esc_html($tc_org['email']); ?></a>
                        </li>
                        <li><span>Web</span><a href="https://<?php echo esc_attr($tc_org['web']); ?>" target="_blank"
                                rel="noopener"><?php echo esc_html($tc_org['web']); ?></a></li>
