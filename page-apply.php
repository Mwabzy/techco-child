...
<div id="primary" class="content-area page-content-area tc-page pt-120 pb-120">
	<div class="container">
		...
		<section class="tc-coursebanner tc-coursebanner--simple tc-reveal">
			...
			<div class="tc-coursebanner__inner">
				<div class="tc-coursebanner__content" data-motion-in>
					...
					<p class="tc-coursebanner__desc">Join a cohort of builders and learners. Our team will walk you
						through your best track, batch, and fees plan over a quick call.</p>
		...
		<section class="tc-section tc-apply-why tc-reveal tc-section--tint">
			...
			<div class="tc-bento tc-bento--4col">
				<?php foreach ($tc_apply_why as $i => $card): ?>
					<div class="tc-feature tc-reveal" style="--delay: <?php echo $i * 80; ?>ms">
						<span
							class="tc-feature__ic tc-feature__ic--<?php echo esc_attr($card['color']); ?>"><?php echo tc_icon($card['ic'], 24); ?></span>
		...
		<section class="tc-section tc-batches-section tc-reveal tc-section--brand">
			<span class="tc-eyebrow">Plan ahead</span>
			<h2 class="tc-section__title">Choose your cohort</h2>
			<p class="tc-muted" style="max-width: 640px;">Dates are indicative. Our team will confirm your exact batch
				and schedule during the counselling call.</p>
		...
		<section class="tc-section tc-apply-section tc-reveal" id="tc-apply-form-anchor">
			<div class="row">
				...
				<div class="col-lg-7 tc-reveal">
					...
					<p class="tc-muted" style="margin-bottom: 28px;">Tell us about yourself. Our team will follow up
						within 24 hours to discuss the best track, timing and payment plan for you.</p>
				...
				<div class="col-lg-5 tc-reveal" style="--delay: 100ms">
					<aside class="tc-apply-panel">
						...
						<div class="tc-apply-panel__item">
							...
							<p><strong>Your application is reviewed</strong><br><span class="tc-muted">Our team reads
									your profile and notes.</span></p>
						</div>
						<div class="tc-apply-panel__item">
							<span class="tc-apply-panel__num">2</span>
							<p><strong>Counselling call scheduled</strong><br><span class="tc-muted">We call within 24
									hours to discuss fit.</span></p>
						</div>
						<div class="tc-apply-panel__item">
							<span class="tc-apply-panel__num">3</span>
							<p><strong>Offer & seat confirmation</strong><br><span class="tc-muted">Get your offer
									letter and lock your seat.</span></p>
						</div>
						...
						<div class="tc-brochure" data-state="locked">
							...
							<a class="tc-btn tc-btn--primary tc-btn--block tc-brochure__link"
								href="<?php echo esc_url(get_stylesheet_directory_uri() . '/assets/files/Training_Brochure.pptx'); ?>"
								download hidden>
...
<?php tc_render_privacy_modal(); ?>
<?php tc_render_consent_modal(); ?>
